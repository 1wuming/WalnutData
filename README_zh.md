...
## 4.1 WalnutData在一阶段目标检测算法的实验结果
 下表为一系列主流算法在WalnutData验证集上的评估。其中，mAP50:95、mAP50、mAP(A1)、mAP(B1)、mAP(B2)、mAP(A2)指标的单位均为“%”，“#Param.”为Parameter的缩写。

|     Model         |     #Param.    |     GFLOPs     |     mAP50    |     mAP50:95    |     mAP50(A1)    |     mAP50(B1)    |     mAP50(B2)    |     mAP50(A2)    |     mAP50:95(A1)    |    mAP50:95(B1)   |   mAP50:95(B2)   |  mAP50:95(A2)   |
|-------------------|----------------|---------------|----------------|-------------|---------------|----------------|------------------|---------------|---------------|----------------|------------------|---------------|
...
\hline
YOLOX[39] & S CSPDarknet & 300 & 4 & 45.4 & 72.8 & 52.9 \\
 &  &  &  & 51.6 & 79.1 & 62.7 \\
 &  &  &  & 54.9 & 82.7 & 67.5 \\
DETR[30] & ResNet50 & 150 & 8 & 14.1 & 34.7 & 8.0 \\
Deformable DETR[40] &  & 50 & 4 & 49.2 & 76.8 & 59.7 \\
DINO[41] & 4scale &  & 12 & 4 & 50.3 & 77.0 & 61.7 \\
Conditional DETR[42] &  & 50 & 8 & 37.9 & 65.5 & 40.9 \\
\hline
\end{tabular}
